...
const CountryDetailCard = ({spot}) => {
    const {name, country, location, description, cost, season, photo, _id} = spot
    return (
        <div>
            <div className="card rounded-sm relative border border-base-300 shadow-sm mb-3">
                ...
                <div className="flex flex-col gap-4 card-body">
                    ...
                    <div className="flex">
                        ...
                        <p className="md:text-base lg:text-lg flex items-center gap-2"><span className="font-semibold">Visit during:</span> {season} season</p>
                    </div>
