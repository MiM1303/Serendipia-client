...
const AllSpots = () => {
    ...
    return (
        <div>
            ...
            <div className="mb-8 md:mb-12 lg:mb-16 justify-center text-2xl flex gap-4 items-center">
                <p>Sort By: </p>
                ...
                <Link to="/all-spots/sorted"><button className="bg-[#f2f7d5] p-3 rounded-xl">Sort</button></Link>
            </div>
